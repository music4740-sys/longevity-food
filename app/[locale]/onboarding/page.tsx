...
export default async function OnboardingLanguagePage({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-zinc-50 px-4 py-10 dark:bg-black">
      <div className="relative isolate w-full max-w-xs overflow-hidden rounded-3xl border border-emerald-200 bg-white px-6 py-7 text-center dark:border-accent-900 dark:bg-zinc-900">
        <div
          aria-hidden
          className="absolute inset-0 -z-10 bg-[radial-gradient(120%_100%_at_50%_-10%,#d1fae5,transparent_60%)] dark:bg-[radial-gradient(120%_100%_at_50%_-10%,#1e2740,transparent_60%)]"
        />
        <div className="mx-auto mb-3 flex h-[52px] w-[52px] items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-600 to-emerald-900 text-2xl dark:bg-none dark:bg-accent-400">
          🌍
        </div>
      ...
      <div className="flex w-full max-w-xs flex-col gap-2">
        {LOCALES.map((l) => (
          <Link
            ...
            className={
              l === locale
                ? "flex items-center gap-3 rounded-2xl border border-emerald-400 bg-emerald-50 px-4 py-3 dark:border-accent-700 dark:bg-accent-950/40"
                : "flex items-center gap-3 rounded-2xl border border-zinc-200 bg-white px-4 py-3 hover:border-emerald-300 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-accent-800"
            }
          >
