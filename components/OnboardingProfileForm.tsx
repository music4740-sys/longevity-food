...
export default function OnboardingProfileForm({ locale }: OnboardingProfileFormProps) {
  ...
  const inputClass =
    "rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50 dark:focus:ring-accent-950";
    ...
    <div className="flex min-h-screen flex-col bg-zinc-50 dark:bg-black">
      ...
      <main className="mx-auto flex w-full max-w-md flex-1 flex-col gap-6 px-4 py-6">
        ...
        <div className="flex flex-col gap-2 rounded-2xl border border-emerald-200 bg-gradient-to-b from-emerald-50 to-white p-4 dark:border-accent-900 dark:from-accent-950/40 dark:to-zinc-950">
          {bmi === null ? (
            <p className="text-sm text-emerald-800 dark:text-accent-300">
            ...
            <>
              ...
              {tdee !== null ? (
                ...
                <p className="text-xs text-emerald-700 dark:text-accent-400">
                  {t.onboarding.calorieNeedsGenderNote}
                </p>
              )}
            </>
          )}
          <p className="text-xs text-emerald-700/80 dark:text-accent-400/80">
        ...
        <div className="flex gap-3">
          ...
          <button
            type="button"
            onClick={() => goNext(true)}
            className="flex-1 rounded-xl bg-gradient-to-br from-emerald-600 to-emerald-800 py-3 text-sm font-semibold text-white dark:bg-none dark:bg-accent-400 dark:text-black"
          >
