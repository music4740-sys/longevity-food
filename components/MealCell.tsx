...
export default function MealCell({ recipeId, mealLabel, locale }: MealCellProps) {
  ...
  return (
    <Link
      ...
      className="flex flex-col gap-1 rounded-xl border border-zinc-200 bg-white p-3 text-sm transition-colors hover:border-emerald-300 hover:bg-emerald-50/50 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-accent-800 dark:hover:bg-accent-950/30"
    >
      ...
      <span className="text-xs font-medium text-emerald-700 dark:text-accent-400">
